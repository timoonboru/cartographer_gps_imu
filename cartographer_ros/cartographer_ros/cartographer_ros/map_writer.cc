...
void WriteOccupancyGridInfoToYaml(const ::nav_msgs::OccupancyGrid& grid,
  ...
  std::ofstream yaml_file(yaml_filename, std::ios::out | std::ios::binary);
  {
    ...
    out << YAML::Key << "width" << YAML::Value << grid.info.width;
    out << YAML::Key << "height" << YAML::Value << grid.info.height;
    out << YAML::Key << "orientation.x" << YAML::Value << grid.info.origin.orientation.x;
    out << YAML::Key << "orientation.y" << YAML::Value << grid.info.origin.orientation.y;
    out << YAML::Key << "orientation.z" << YAML::Value << grid.info.origin.orientation.z;
    out << YAML::Key << "orientation.w" << YAML::Value << grid.info.origin.orientation.w;
    ...
    out << YAML::Key << "origin" << YAML::Value << YAML::Flow << YAML::BeginSeq
        ...
        << grid.info.origin.position.z << YAML::EndSeq;
