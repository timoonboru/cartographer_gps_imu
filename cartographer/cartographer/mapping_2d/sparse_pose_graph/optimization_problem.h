...
struct NodeData {
  common::Time time;
  transform::Rigid2d initial_point_cloud_pose; // mnf tracking_2d_to_local
  transform::Rigid2d point_cloud_pose; // mnf tracking_2d_to_global
};

struct SubmapData {
  transform::Rigid2d pose; //mnf Tracking_2d_to_global
};
